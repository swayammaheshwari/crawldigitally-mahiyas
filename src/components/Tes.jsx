...
const Testimonial = () => {
  return (
    <div
      style={{ position: "relative", marginTop: "10px", marginBottom: "100px" }}
    >
      <div class="container">
        <div
          style={{
        ...
        <h2 id="testimonial-heading" class="text-primary text-center">
          CLIENT'S LOVE
        </h2>
          ...
          <div class="owl-item">
            <div class="card d-flex flex-column">
              ...
              <div class="testimonial">
                ...
                dolores molestias veniam inventore itaque eius iure omnis,
                temporibus culpa id.{" "}
              </div>
